...
describe.each([
  "app/(admin)/keystone/learn/courses/[id]/course-editor.tsx",
  "app/(admin)/keystone/learn/lessons/[id]/lesson-editor.tsx",
  "app/(admin)/keystone/learn/videos/[id]/video-editor.tsx",
  "app/(admin)/keystone/glossary/[id]/glossary-editor.tsx",
])("%s", (path) => {
