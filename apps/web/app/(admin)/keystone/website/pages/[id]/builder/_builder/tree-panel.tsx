...
// /keystone/navigation already does") turned out to describe code that
// doesn't exist — `/keystone/navigation` itself only has up/down buttons
// (verified against apps/web/app/(admin)/keystone/navigation/
