...
export default async function WebsitePagesPage({
  searchParams,
}: PageProps<"/keystone/website/pages">) {
  ...
  return (
    ...
    >
      <SubNav
        ...
        items={[
          { href: "/keystone/website/pages?tab=pages", label: t("websitePages"), exact: false },
          { href: "/keystone/website/pages?tab=designs", label: t("websiteDesigns"), exact: false },
          { href: "/keystone/website/pages?tab=global", label: t("websiteGlobal"), exact: false },
