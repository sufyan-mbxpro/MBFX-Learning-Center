...
//
// The same form as `/keystone/market/provider`, loaded by the same function — the
// owner asked for the provider API "in settings as well, on both sides". The
// AI provider already lives in both places (`/keystone/settings/ai` and
// `/keystone/ai/providers`); this puts the other sealed provider key where an
