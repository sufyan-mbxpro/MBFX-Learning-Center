...
//
// `variant="usage"` drops the tier section and saves the limits alone
// (ADR-120), for a screen that sets the tiers elsewhere. The Connection tab
// was that screen until changes-51 made Budget & limits a tab beside it.
