 ...
 * `/keystone/media` is not a News & Analysis resource — it is the standalone
...
export function articlesSubnavItems(labels: {
  ...
  return [
    { href: "/keystone/articles", label: labels.articles, exact: true },
    { href: "/keystone/articles/categories", label: labels.categories },
    { href: "/keystone/articles/tags", label: labels.tags },
  ];
}
