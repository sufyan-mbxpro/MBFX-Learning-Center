...
export default async function AdminHome({ searchParams }: PageProps<"/keystone/dashboard">) {
  ...
  // items" linking to `/keystone/navigation` — a screen ADR-038 hid, which made it
  ...
  const secondaryCards = [
    ...
    overview.emailDeliveries === undefined
      ? undefined
      : {
          href: "/keystone/settings/email/log",
          icon: Mail,
