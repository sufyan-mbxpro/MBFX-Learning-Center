    ...
    <div className="flex justify-end">
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          <DropdownMenuItem render={<Link href={`/keystone/learn/lessons/${row.id}`} />}>
    ...
    () => [
      {
        ...
        cell: ({ row }) => (
          <div className={`flex max-w-80 flex-col ${row.original.deleted ? "opacity-60" : ""}`}>
            <Link
              href={`/keystone/learn/lessons/${row.original.id}`}
      ...
      },
      {
        ...
        cell: ({ row }) => (
          <div className="flex max-w-56 flex-col">
            <Link
              href={`/keystone/learn/courses/${row.original.courseId}`}
