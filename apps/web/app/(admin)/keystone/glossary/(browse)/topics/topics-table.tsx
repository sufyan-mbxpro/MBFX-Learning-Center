...
// `/keystone/glossary/topics/[id]`; this is a table, so it gets the toolbar search
    ...
    <div className="flex justify-end">
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          <DropdownMenuItem render={<Link href={`/keystone/glossary/topics/${row.id}`} />}>
    ...
    () => [
      {
        ...
        cell: ({ row }) => (
          <div className="flex max-w-96 flex-col gap-1">
            <Link
              href={`/keystone/glossary/topics/${row.original.id}`}
