...
// is to help someone FIND a term. Editing moved to `/keystone/glossary/[id]`;
// this is a table.
//
    ...
    <div className="flex justify-end">
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          <DropdownMenuItem render={<Link href={`/keystone/glossary/${row.id}`} />}>
            ...
            <DropdownMenuItem
              ...
              onClick={() =>
                run(async () => {
                  ...
                  router.push(`/keystone/glossary/${id}`);
                })
              }
            >
    ...
    () => [
      {
        ...
        cell: ({ row }) => (
          <div className="flex max-w-80 flex-col gap-1">
            <Link
              href={`/keystone/glossary/${row.original.id}`}
