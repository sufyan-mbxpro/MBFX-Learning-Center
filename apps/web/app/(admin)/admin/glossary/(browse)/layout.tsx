...
// `/admin/glossary/[id]` and `/admin/glossary/topics/[id]` — sit OUTSIDE it,
  ...
  return (
    <HeaderActionsProvider>
      <div className="flex w-full flex-col gap-6">
        ...
        <SubNav
          items={[
            { href: "/admin/glossary", label: t("glossaryTermsTab"), exact: true },
            { href: "/admin/glossary/topics", label: t("glossaryTopics") },
          ]}
        />
        {children}
      </div>
