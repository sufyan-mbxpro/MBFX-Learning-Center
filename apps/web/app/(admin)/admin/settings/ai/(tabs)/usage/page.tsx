...
// The Usage tab of Settings → AI (changes-51; it was `/admin/ai`'s landing
...
export default async function AiUsagePage({ searchParams }: PageProps<"/admin/settings/ai/usage">) {
