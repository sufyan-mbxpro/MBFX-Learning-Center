...
export default async function EmailLogPage({
  searchParams,
}: PageProps<"/admin/settings/email/log">) {
  const subject = await requirePermission("email.log.view");
  ...
  const [{ navEntries }, page, counts] = await Promise.all([
  ...
  return (
    <SettingsScreen
      ...
      title={t("email.logTitle")}
      description={t("email.logDescription")}
    >
