 ...
 * `/admin/learn` beside the lessons whose permission keys they share
 * (ADR-058 #6, ADR-068).
 */
export const ENTITY_HREFS: Record<DashboardContentEntity, string> = {
  courses: "/admin/learn/courses",
  lessons: "/admin/learn/lessons",
  quizzes: "/admin/learn/quizzes",
  glossary: "/admin/glossary",
  videos: "/admin/learn/videos",
