...
// `/admin/learn/videos/[id]` sits OUTSIDE it: an editor is not a third tab.
  ...
  return (
    <HeaderActionsProvider>
      <div className="flex w-full flex-col gap-6">
        ...
        <SubNav
          items={[
            { href: "/admin/learn/videos", label: t("learnVideos"), exact: true },
            { href: "/admin/learn/videos/categories", label: t("videos.manageCategories") },
          ]}
        />
        {children}
      </div>
