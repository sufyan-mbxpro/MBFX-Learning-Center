// The limits form's labels and model options, built once and shared by
// `/admin/ai/limits` and `/admin/settings/ai` (ADR-120). A second copy of forty
// `t()` calls is a second place for one of them to be forgotten.
