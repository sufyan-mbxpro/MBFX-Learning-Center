...
export default async function AiProvidersPage() {
  ...
  return (
    <AdminPage
      title={tAi("providersTitle")}
      description={tAi("providersDescription")}
      actions={
        <Button render={<Link href="/admin/ai/providers/new" />}>
              ...
              <CardContent className="flex flex-col gap-3">
                ...
                <div className="flex justify-end">
                  <Button
                    variant="outline"
                    size="sm"
                    render={<Link href={`/admin/ai/providers/${provider.id}`} />}
                  >
                    {t("edit")}
                  </Button>
                </div>
